...
GNUTERM = "qt"
file = "Model Summaries - proc.csv"
x = 0.0
## Last datafile plotted: "Model Summaries - proc.csv"
set term png size 1200,1200
set output 'plotting.model.summaries.png'
set multiplot
...
set size 1,.5
set origin 0,.5
set x2tics border in scale 1,0.5 mirror rotate by 60  offset character 0, 0, 0 left
set ytics nomirror
set y2tics nomirror 
set ylabel 'Mean error [fs]'
set y2label 'latency [ns] for 250 MHz clock'
set log y
set log y2
unset xtics
...
set object 2 rect from -.5,100 to 5.5,1e3 fc rgb 'red' fs pattern 5 noborder back
plot file u 0:6:xtic(1) w points lw 2 title 'LUTs',\
	file u 0:7 w points lw 2 title 'DSPs',\
	file u 0:10 w points lw 2 title 'Regs'
unset multiplot
#    EOF
