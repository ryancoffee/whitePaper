...
Given the SLAC development of the ePix family of x-ray imaging detectors, we expect an eventual full frame readout at the full 1 MHz capability of LCLS-II and the High Energy upgrade KCKS-II-HE.
...
%run at a MHz full frame readout is ultimate goal. 
...
This impending data liability poses unique challenges and excessive scale for DOE user facilities that prohibit traditional data acquisition and Cloud hosted data mining.
We require information acquisition whereby our scientific instruments directly record actionable information, not raw data, in a form that can flexibly handle the weekly redefinition of ``information''---more likely redefinition every shift.
...
%\emph{Year 3: \$1M }
HERE HERE HERE HERE
In Year 3 we will incorporate emerging AI acceleration chips makers to integrate what had previously been hosted on the frame-grabber into the camera electronics.
